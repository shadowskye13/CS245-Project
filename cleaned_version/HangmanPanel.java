...
public class HangmanPanel extends JPanel{
    ...
    // Hangman pic
    private ImageIcon hangmanHead = new ImageIcon(getClass().getResource("/img/HangmanWithHead.png"));
    private ImageIcon hangmanBody = new ImageIcon(getClass().getResource("/img/HangmanWithBody.png"));
    private ImageIcon hangmanArm1 = new ImageIcon(getClass().getResource("/img/HangmanOneArm.png"));
    private ImageIcon hangmanArm2 = new ImageIcon(getClass().getResource("/img/HangmanFinal.png"));
    private ImageIcon hangmanLeg1 = new ImageIcon(getClass().getResource("/img/HangmanOneLeg.png"));
    private ImageIcon hangmanLeg2 = new ImageIcon(getClass().getResource("/img/HangmanBothLegs.png"));
